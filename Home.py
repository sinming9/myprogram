...
with st.expander("📋 전체 프로그램 목록", expanded=False):
    ...
    프로그램 = [
        ...
        ("📊", "자산배분 현황", "주식·ETF·펀드·코인을 계좌별로 · 금리 국면과 대조",
         "pages/7_📊_자산배분.py"),
        ("💎", "순자산", "내 몫 / 가족 몫 / 가구 합계를 나눠서 · 전국 백분위",
         "pages/7_💎_순자산.py"),
        ("🔮", "미래 자산", "매일·매달 모으는 돈이 얼마나 불어나는지 (가정 기반)",
         "pages/7_🔮_미래_자산.py"),
        ("🧓", "연금", "국민연금·퇴직연금·연금저축으로 보는 노후 월 수령액",
         "pages/7_🧓_연금.py"),
        ("🏨", "호텔 가격 알림", "날짜·인원·아이 만나이로 지켜보다 싸지면 텔레그램 알림",
         "pages/8_🏨_호텔_가격_알림.py"),
