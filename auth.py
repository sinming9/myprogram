...
필요기능 = {
    ...
    "engines.portfolio": ["종목_계산", "집계", "요약", "배당_달력", "리밸런싱",
                         ...
                         "종목_합산", "집중도", "자산군_확인필요", "계좌색",
                         "금액표시", "계좌_제약_점검", "한국_종목코드인가",
                         "조정_제약계좌", "위험자산_비중", "위험자산_한도계좌",
                         "자산군_짐작", "인출등급", "배당_인출별", "인출_구분",
                         "ISA_이력_집계", "ISA_이력열",
                         "인출_등급순", "인출_이름", "인출_설명", "인출_색",
                         "오프라인_평가액", "오프라인_계좌별",
                         "금액_한글", "증감_한글", "시세_모으기",
                         "현황_스냅샷", "텔레그램_자산요약", "기여도",
                         "목표기준_추측", "리밸런싱_신호", "엇갈린_해외",
                         "기본_조정계좌", "조정계좌_정하기", "_시세열쇠"],
    ...
    "engines.fx": ["환율_가져오기", "평균_계산", "금액표시",
                  "단기_요약", "단기_메시지", "시점_값",
                  "텔레그램_통화요약", "텔레그램_전체요약",
                  "범위_위치", "구간_이름", "범위_막대", "체감_환산"],
    "engines.brief": ["브리핑_만들기", "볼것_찾기", "오늘_모드", "기본_임계"],
    "engines.telegram": ["보내기", "텔레그램_보내기"],
    "engines.loan": ["스케줄_생성", "요약", "진행_현황", "실적_대조"],
    "engines.future": ["계획_집계", "적립_시뮬", "시나리오_묶음", "목표_도달",
                      "실질가치", "과거_속도", "추세_연장", "기본_계획",
                      "주기_목록", "통화_목록", "월납입_환산", "월수익률"],
    "engines.hotel": ["감시열", "기본_감시표", "행_정리", "부족한것",
                     "아이나이_읽기", "아이나이_글자", "만나이", "일정_설명",
                     "도시_찾기", "호텔_검색", "호텔_검색_다중사이트",
                     "호텔목록_해석", "최저가",
                     "조건_판정", "알림_문장", "기록_추가", "이력_요약",
                     "기준가_정하기", "기억_읽기",
                     "텔레그램_보내기", "텔레그램_채팅찾기",
                     "알림_보내기", "쓸_수_있는_채널",
                     "방목록_해석", "방_최저가", "방목록_조회",
                     "한줄_확인", "기본_호스트", "기본_통화"],
    "engines.agoda": ["도시_찾기", "합친_id", "호텔목록_해석", "호텔_검색",
                     "최저가", "방목록_해석", "방_최저가", "방목록_조회",
                     "기본_호스트"],
    ...
    "engines.networth": ["백분위", "순자산_계산", "추이_분석", "구간_분석",
                        ...
                        "표_집계", "행_정리", "소유자_목록", "내지분_비율",
                        "지분_비었나", "지분_어긋남",
                        "자동값_반영", "옛설정_변환", "기본_자산표", "만기_표시"],
